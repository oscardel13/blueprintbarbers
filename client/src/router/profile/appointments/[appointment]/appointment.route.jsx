...
import MapSection from "../../../barber/components/info-card/components/map-section/map-section.component";
...
const Appointment = () => {
  ...
  return (
    <div className="flex flex-col gap-5 w-full max-w-[500px] min-h-screen">
      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-row gap-3">
            ...
            />
            <Link
              to={`/barbers/${appointment.barber._id}`}
              className="underline"
            >
      ...
      <div className="px-1">
        <button
          className="py-1 w-full h-12 bg-gray-800 text-white rounded-lg z-30 hover:bg-gray-600"
