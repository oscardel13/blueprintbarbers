...
import DashboardNav from "../components/Nav/nav.component";
import DashboardGuard from "../barber-dashboard.guard";
  ...
  return (
    <DashboardGuard>
      <div className="flex w-screen">
        ...
        >
          {!isXlScreen && openSidebar && (
            <div className="bg-black opacity-50 inset-0 h-screen w-screen z-1 fixed" />
          )}
          <Outlet />
        </div>
        ...
        {window.innerWidth < 1280 && (
          <button
            ...
            } absolute top-0 xl:left-[280px] p-4`}
