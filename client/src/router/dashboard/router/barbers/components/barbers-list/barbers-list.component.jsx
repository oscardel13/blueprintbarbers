...
const BarberList = ({ barbers }) => {
    ...
    return (
        ...
        <div className='min-w-[1200px] w-[-webkit-fill-available]'>
            ...
            {barbers.map((barber) => (
                <div className="flex items-center bg-white p-4 mb-0 border border-gray-300 rounded-md h-32" key={barber.gid}>
                    ...
                    <div className="w-1/6">
                        <Link to={`/dashboard/barbers/${barber.gid}/edit`} className="bg-gray-800 hover:bg-gray-700 text-white px-3 py-2 rounded-md">
                            Edit
                        </Link>
                    </div>
                </div>
